...
class AugmentationConfig:
    ...
    # Mixup augmentation (ViT-specific, MANDATORY per improvement plan)
    apply_mixup: bool = True
    mixup_alpha: float = 0.4  # Beta distribution parameter

    # Patch dropout (ViT-specific)
    apply_patch_dropout: bool = True
    patch_dropout_ratio: float = 0.1  # fraction of patches to drop
...
class ModelConfig:
    ...
    vit_model_name: str = "eeg_vit_tiny_patch8_64"
